    ...
    <footer>
      ...
      <div class="members">
        ...
        <div class="members-img">
          ...
          <img src="/images/logo/korea.jpg" />
          <img src="/images/logo/rus.jpg" />
        </div>
      </div>
      <!-- 版权 -->
      <div class="copyright">        
...
@header: {
  ...
  // 中间居中title
  // 下面一个button
  //   background: url("image/home_1_2.jpg");
  // height: 100px;
  display: flex;
  flex: 2;
  flex-direction: column;
...
@footer: {
  //   background: url("image/home_1_2.jpg");
  background: rgba(47, 221, 221, 0.329);
  display: flex;
  flex: 1;
